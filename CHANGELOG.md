## Changelog
+ Minimum plugin version supported by server: 2.8.0
...
+ [[#125](https://github.com/HeyPublisher/heypublisher-submission-manager/issues/125)] : Submission List and Details should use JSON API endpoint, including:
